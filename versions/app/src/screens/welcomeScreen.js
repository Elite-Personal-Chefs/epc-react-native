...
export default function WelcomeScreen({ navigation }) {
	...
	const chefFlow = [
		{
			title: (
				<Text style={styles.benefit_text}>
					Host <Text style={globalStyles.italic}>your</Text> unique events!
				</Text>
			),
		...
		},
		{
			title: (
				<Text style={styles.benefit_text}>
					Control <Text style={globalStyles.italic}>your</Text> schedule.
				</Text>
			),
		...
		},
		{
			title: (
				<Text style={styles.benefit_text}>
					Create <Text style={globalStyles.italic}>your</Text> menus. {"\n"}Cook{" "}
					<Text style={globalStyles.italic}>your</Text> food!
				</Text>
			),
		...
		},
		{
			title: (
				<Text style={styles.benefit_text}>
					Set <Text style={globalStyles.italic}>your</Text> pricing.
				</Text>
			),
	...
	const guestFlow = [
		{
			title: (
				<Text style={styles.benefit_text}>Browse culinary events{"\n"}happening around you.</Text>
			),
		...
		},
		{
			title: (
				<Text style={styles.benefit_text}>
					See events you like? Book{"\n"}your reservation in minutes!
				</Text>
			),
		...
		{
			title: (
				<Text style={styles.benefit_text}>Enjoy the experience!{"\n"}It’s as simple as that.</Text>
			),
