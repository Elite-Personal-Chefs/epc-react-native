...
export default function FaqScreen({ navigation }) {
    ...
    function mailtoComponent() {
        return (
            <Text onPress={() => mailto('consultation@elitepersonalchefs')} style={globalStyles.textLinkText}>consultation@elitepersonalchefs.com</Text>
        );
    }
                ...
                <ScrollView >
                    <View style={globalStyles.reset} >
                        ...
                        <View style={globalStyles.reset}>
                            ...
                            <Text style={styles.answer}>It’s easy to join! Send an email to {mailtoComponent()} with “EPC Application” in the subject line. Attach resume, portfolio, head shot, biography, social media tags, and/or any other pertinent information you would like us to see. We are excited to meet you! </Text>
                        </View>
                        <View style={globalStyles.reset}>
                            ...
                            <Text style={styles.answer}>Liability Insurance; contact {mailtoComponent()} for further information and to be connected with our insurance provider.</Text>
                        ...
                        <View style={globalStyles.reset}>
                            ...
                            <Text style={styles.answer}>You can certainly host events in your home or at someone else’s. If you are in need of a host space for the evening, we currently collaborate with various private venues. One of our team members will help secure the perfect fit for your event. The cost of the space rental various based on location, guest count and availability. Feel free to reach out to {mailtoComponent()} and one of our team members will be happy to assist you.</Text>
