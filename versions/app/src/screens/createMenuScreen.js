...
export default function CreateMenuScreen({ route, navigation }) {
	...
	const addPhotoToMenu = async (url) => {
		...
		setPhotoMode(false);
		Alert.alert("Congratulations", "Your menu has been created.", [
			{ text: "View Menus", onPress: () => navigation.navigate("Your Menus") },
		]);
	};
							...
							<ScrollView>
								...
								{!menuImg ? (
									<Text style={[globalStyles.subtitle, styles.subtitle_text]}>
										Showcase your dishes with at least one high quality pic.
									</Text>
								) : (
									<Text style={[globalStyles.subtitle, styles.subtitle_text]}>
								...
								>
									{({
										...
										<View style={styles.formik}>
											<Text style={globalStyles.blurb}>
												Create your menu by filling out the following details and then adding
												courses and items down below.
											</Text>
								...
								<View style={modal.modalBackground}>
									<View style={modal.modalView}>
										...
										<View style={modal.modalHeader}>
											{isEdit && (
												<Text style={{ fontSize: 17, color: Theme.PRIMARY_COLOR }}>
													Edit {isEdit.type}
												</Text>
											)}
										</View>
										...
										{!isEdit && (
											<View style={styles.toggleBox}>
												<Text
													style={[
														styles.toggleLabel,
														!isCourse ? styles.toggleActive : styles.toggleInActive,
													]}
												>
													Add Item
												</Text>
												<Switch
													trackColor={{
														false: Theme.SECONDARY_COLOR_LIGHT,
														true: Theme.SECONDARY_COLOR_LIGHT,
													}}
										...
										<CustomButton
											...
											text={!isCourse ? "ADD ITEM" : "ADD COURSE"}
										/>
									</View>
								</View>
							</Modal>
