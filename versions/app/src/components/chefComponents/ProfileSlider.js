...
export default function ProfileSlider({ handleFormUpdates, userData }) {
	...
	for (let i = 1; i <= totalScreens; i++) {
		...
		bullets.push(
			<Text key={i} style={[styles.bullet, { opacity: activeImage === i ? 0.9 : 0.3 }]}>
				&bull;
			</Text>
		);
	}
	...
	return (
		<View style={styles.carousel}>
			...
			>
				{({ values, errors, handleChange, setFieldValue, handleBlur, isValid, handleSubmit }) => (
					<>
						...
						<KeyboardAvoidingView behavior={Platform.OS == "ios" ? "padding" : "height"}>
							...
							>
								...
								<View style={styles.screen}>
									<Text style={[globalStyles.h1, styles.headline_text]}>
										Which cuisines do you serve, Chef?
									</Text>
								...
								<View style={styles.screen}>
									<ScrollView showsVerticalScrollIndicator={false}>
										...
										<Text style={[globalStyles.subtitle, styles.subtitle_text]}>
											Talk about your background and achievements. Show off a little!
										</Text>
										<TextInput
											multiline={true}
								...
								<View style={styles.screen}>
									<ScrollView showsVerticalScrollIndicator={false}>
										<Text style={[globalStyles.h1, styles.headline_text]}>
											Hey Chef, let’s set up your profile photo
										</Text>
										<Text style={[globalStyles.subtitle, styles.subtitle_text]}>
										...
										<View style={globalStyles.list_cont}>
											<Text style={globalStyles.list_bullet}>•</Text>
											<Text style={globalStyles.list_item}>
												Use a picture of yourself or cooking instead of a logo. It’s more personal
												that way.
											</Text>
										</View>
										<View style={globalStyles.list_cont}>
											<Text style={globalStyles.list_bullet}>•</Text>
											<Text style={globalStyles.list_item}>Try to use a solid background.</Text>
										</View>
										<View style={globalStyles.list_cont}>
											<Text style={globalStyles.list_bullet}>•</Text>
											<Text style={globalStyles.list_item}>Use a clear photo.</Text>
										</View>
									</ScrollView>
								</View>
							</ScrollView>
						...
						<View style={styles.footer}>
							...
							<View>
								<TouchableOpacity
									activeOpacity={0.7}
									style={[styles.close_button, { position: "relative" }]}
									disabled={!isValid}
									onPress={handleSubmit}
								>
									<Text
										style={{ color: Theme.SECONDARY_COLOR, fontWeight: "bold", textAlign: "right" }}
									>
										DONE
									</Text>
								</TouchableOpacity>
